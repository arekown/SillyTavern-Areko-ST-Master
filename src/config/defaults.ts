...
// L(de, en): waehlt das Label nach Sprache. Descriptions bleiben immer englisch.
    ...
    categories: [
      {
        ...
        fields: [
          ...
          str('f_time', 'time', de ? 'Zeit' : 'Time',
            'Resulting clock time after adding timeElapsed. Format: HH:MM:SS; MM/DD/YYYY (Day Name)'),
          str('f_location', 'location', de ? 'Ort' : 'Location',
            'Specific scene location with increasing specificity'),
          str('f_weather', 'weather', de ? 'Wetter' : 'Weather',
            'Current weather conditions and temperature'),
          str('f_changeLog', 'changeLog', de ? 'Änderungen' : 'Changes',
          ...
          lst('f_charsPresent', 'charactersPresent', de ? 'Anwesende Charaktere' : 'Characters present',
