    ...
    <div className="areko-tab">
      <div className="areko-field">
        ...
        <select
          ...
          onChange={(e) => update((s) => { s.profileId = e.target.value; })}
        >
      ...
      <div className="areko-field">
        ...
        <select className="text_pole" value={settings.autoMode} onChange={(e) => update((s) => { s.autoMode = e.target.value as AutoMode; })}>
